...
const Rewards: Component<{}> = (props) => {
  return (
    <section class="grid sm:gap-y-10  my-20 grid-cols-1 sm:grid-cols-2 items-center overflow-x-hidden sm:mr-[-10rem]">
      {/* Dual Phone */}
      ...
      {/* Laptop */}
      <div class="w-full sm:w-[972px] sm:h-[588px] sm:right-[200px] relative sm:mr-[-10rem]">
        <img
          class="sm:relative w-full sm:w-[972px] sm:h-[588px] sm:mr-[-10rem]"
          src={Laptop}
        />
      </div>
    </section>
